package com.huanghehua.www.ioc.util;
...
public class ScannerUtils {
        ...
        try {
            ...
            while (resources.hasMoreElements()) {
                ...
                if (file.equals(protocol)) {
                    stream = Stream.concat(stream, getFileFromDirectory(url.getPath(), suffix).stream());
                    ...
                    try {
                        ...
                        while (entries.hasMoreElements()) {
                            ...
                            stream = Stream.concat(stream, getFileFromDirectory(name, suffix).stream());
                        }
                    }
                    catch (IOException e) {
                        e.printStackTrace();
    ...
    private static final Logger LOGGER =
            Logger.getLogger("com.huanghehua.www.ioc.util.ScannerUtils");
}
